        ...
        <div class="verify-modal-main" :style="'width: ' + (clientWidth - 30) + 'px;'">
            <div class="modal-main-content">
                ...
                <div class="main-content-jigsaw">
                    ...
                    <img class="content-jigsaw-bg" src="https://ycpd-assets.oss-cn-shenzhen.aliyuncs.com/ycpd/customer/share-benefit-system/jigsaw-bg.jpg" />
                    <img class="content-jigsaw-front" :style="'left: ' + jigsawMovepx  + 'px;'" src="https://ycpd-assets.oss-cn-shenzhen.aliyuncs.com/ycpd/customer/share-benefit-system/jigsaw-front.png" />
                </div>
