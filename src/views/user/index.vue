        ...
        <div class="user-block-container">
            ...
            <div class="user-assets-main user-block-main">
                ...
                <div class="assets-main-row flex-start">
                    ...
                    <div class="assets-main-item flex-center flex-rest" @click="jumpToRouter('/maintenance/record/buy')">
                        <div class="item-container">
    ...
    <div class="user-proto-content user-otherfun">
        <div class="proto-content">
            ...
            <div class="user-otherfun-other">
                ...
                <div class="otherfun-other-item flex-center" @click="jumpToRouter('/maintenance/record/search')">
                    <div class="other-item-content flex-column-center">
                        <div class="other-item-icon">
