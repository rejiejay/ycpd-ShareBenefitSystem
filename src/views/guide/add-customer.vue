<!-- 新增客户教程 -->
<template>
<div class="add-customer flex-center" @click="nextStep" >
    <img class="add-customer-backgrount" 
        :src="`https://ycpd-assets.oss-cn-shenzhen.aliyuncs.com/ycpd/customer/share-benefit-system/guide/add-customer/bg-${stepNo}.png`" 
        alt="guidebg"
    />
</div>
</template>
