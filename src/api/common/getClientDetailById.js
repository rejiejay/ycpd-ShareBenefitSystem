 ...
 * 根据客户id 获取 客户信息
 */
let getClientDetailById = self => apibasics.get(`${config.url.origin}/ycpd/cas/client/getById?token=${window.localStorage.getItem('ycpd_token')}&clientId=${window.localStorage.getItem('ycpd_clientId')}`, '客户详情', self);

export default getClientDetailById;
