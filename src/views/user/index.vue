    ...
    <div class="user-wallet-block user-block">
        <div class="user-block-container">
            ...
            <div class="user-wallet-title user-block-title flex-start-center">
                ...
                <div class="wallet-title-btn flex-start-center" @click="jumpToRouter('/user/wallet')">
                    <span>提现/账单</span>
                    ...
                    <div class="assets-main-item flex-center flex-rest" style="border-right: 1px solid #ddd;">
                        <div class="item-container">
                            <div class="item-count flex-center" style="color: #FFA100">
                                <span>0</span>
                                <img style="position: absolute; left: 50%; margin-left: 10px;display: block;width: 40px;height: 14.5px;"
                                    alt="可赠送" 
                                    src="data:image/png;base64," 
                                />
                            </div>
                            <div class="item-describe">我的礼品</div>
                        </div>
                    </div>
                    <!-- <div class="assets-main-item flex-center flex-rest" @click="jumpToRouter('/maintenance/record/buy')"> 这个必须和查博士同步上线 -->
                    <div class="assets-main-item flex-center flex-rest">
                        <div class="item-container">
    ...
    <div class="user-proto-content user-otherfun">
        <div class="proto-content">
            ...
            <div class="user-otherfun-other">
                ...
                <div class="otherfun-other-item flex-center" @click="upgrading">
                <!-- <div class="otherfun-other-item flex-center" @click="jumpToRouter('/maintenance/record/search')"> 1.3版本无法上线, 所以显示正在升级中 -->
                    <div class="other-item-content flex-column-center">
                        <div class="other-item-icon">
                ...
                <div class="otherfun-other-item flex-center" @click="contactUs">
                    <div class="other-item-content flex-column-center">
                        ...
                        <div class="other-item-describe">专属客服</div>
                    </div>
                </div>
